...
APIKEY = "AIzaSyACVh1r-ZaBH5dkGs8z4jQffFdTP72Usvc"
...
def parse(creds, calid):
    ...
    while counter < end:
        ...
        print(nextDay)
        print(dayToInt(Day))
        createEvent(creds, localStart, localEnd, className, calid, dayToInt(Day))
        lastDay = currDay
        counter += 1
    """
    #print("after run\n")
...
def createEvent(creds, startDate, endDate, className, calid, dayInc):
